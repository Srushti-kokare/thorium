...
router.get('/test-me', function (req, res) {n
    obj1.welcome("Welcome to my application. I am Srushti kokare and a part of FunctionUp Thorium cohort.");
